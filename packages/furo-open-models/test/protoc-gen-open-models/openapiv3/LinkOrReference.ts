...
import {
  Link as OpenapiV3Link,
  type ILink as IOpenapiV3Link,
  type TLink as TOpenapiV3Link,
} from './Link';
...
export class LinkOrReference extends FieldNode {
  ...
  constructor(
    ...
    // Set required fields
    [].forEach(fieldName => {
      (this[fieldName as keyof LinkOrReference] as FieldNode).__meta.required =
        true;
    });
