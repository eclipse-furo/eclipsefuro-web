...
import { Decimal as FuroTypeDecimal, type IDecimal as IFuroTypeDecimal, type TDecimal as TFuroTypeDecimal } from "../type/Decimal";
...
export class DecimalRange extends FieldNode {
  ...
  constructor(initData?: IDecimalRange, parent?: FieldNode, parentAttributeName?: string) {
    ...
    // Set required fields
    [].forEach(fieldName => {
      (this[fieldName as keyof DecimalRange] as FieldNode).__meta.required = true;
    });
  ...
  toLiteral(): IDecimalRange {
    return super.__toLiteral() as IDecimalRange;
  }
}
