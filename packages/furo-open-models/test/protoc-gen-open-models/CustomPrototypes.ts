 ...
 */
ToString.set("furo.cube.Colour", (d: Colour) => `rgba(${d.red.toString()}, ${d.green.toString()}, ${d.blue.toString()}, ${d.alpha.value.toFixed(2)})`);
...
ToString.set("furo.type.DecimalRange", (d: DecimalRange) => `${d.start.toString()} - ${d.end.toString()}`);
ToString.set("furo.type.Identifier", (v: Identifier) => v.id.toString());
ToString.set("furo.type.Defaults", (v: Identifier) => v.id.toString());
