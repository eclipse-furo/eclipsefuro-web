...
export class Uint32AttributesEntry extends FieldNode {
  ...
  constructor(
    initData?: IUint32AttributesEntry,
    parent?: FieldNode,
    ...
    [].forEach(fieldName => {
      (
        this[fieldName as keyof Uint32AttributesEntry] as FieldNode
    ...
    [].forEach(fieldName => {
      (this[fieldName as keyof Uint32AttributesEntry] as FieldNode).__readonly =
        true;
    });
