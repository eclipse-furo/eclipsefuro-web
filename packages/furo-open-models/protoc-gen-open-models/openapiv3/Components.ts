...
export class Components extends FieldNode {
  ...
  constructor(
    ...
    this._schemas = new OpenapiV3SchemasOrReferences(
      undefined,
      this,
      'schemas',
    );

    this._responses = new OpenapiV3ResponsesOrReferences(
      undefined,
      this,
      'responses',
    );

    this._parameters = new OpenapiV3ParametersOrReferences(
      undefined,
      this,
      'parameters',
    );
    ...
    this._requestBodies = new OpenapiV3RequestBodiesOrReferences(
      undefined,
      this,
      'requestBodies',
    );
    ...
    this._securitySchemes = new OpenapiV3SecuritySchemesOrReferences(
      undefined,
      this,
      'securitySchemes',
    );
