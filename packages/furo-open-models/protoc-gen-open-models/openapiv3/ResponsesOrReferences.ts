...
export class ResponsesOrReferences extends FieldNode {
  ...
  constructor(
    initData?: IResponsesOrReferences,
    parent?: FieldNode,
    ...
    [].forEach(fieldName => {
      (
        this[fieldName as keyof ResponsesOrReferences] as FieldNode
    ...
    [].forEach(fieldName => {
      (this[fieldName as keyof ResponsesOrReferences] as FieldNode).__readonly =
        true;
    });
